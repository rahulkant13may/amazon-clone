...
function RegisterUser() {
    ...
    const registerUser = (event) => {
        ...
        if(password !== confirm_password){
            console.log("password field=====", document.querySelectorAll(".password")[0])
            document.querySelectorAll(".password")[0].setAttribute("style", "border-color: #d00;box-shadow: 0 0 0 3px rgba(221,0,0,.1) inset")
            document.querySelectorAll(".password")[1].setAttribute("style", "border-color: #d00;box-shadow: 0 0 0 3px rgba(221,0,0,.1) inset")
        }
        ...
        <div className="login">
            ...
            <div className="login__container email">
                ...
                <form>
                    ...
                    <h5>Password</h5>
                    <input class="password" value={password} onFocus={inputFocus} onBlur={inputBlur} onChange={event => setPassword(event.target.value)} type="password"  placeHolder="At least 6 characters"/>
                    {
                    ...
                    <input class="password" value={confirm_password} onFocus={inputFocus} onBlur={inputBlur} onChange={event => setConfirmPassword(event.target.value)} type="password"/>
                    {
